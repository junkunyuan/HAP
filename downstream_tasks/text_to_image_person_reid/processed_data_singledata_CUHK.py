...
def parse_args():
    ...
    parser.add_argument('--out_root', default='./processed_data_singledata_CUHK_nos', type=str) # processed_data_spa_img
    ...
    for id_new, data_save_by_id_i in data_save_by_id.items():
        ...
        for data_save_by_id_i_i in data_save_by_id_i:
            ...
            for j in range(len(data_save_by_id_i_i['tokens'])):
                ...
                bert_caption_id = tokenizer.encode(caption_j, add_special_tokens=False)
