...
optimizer = dict(type='AdamW', lr=1.1e-3, betas=(0.9, 0.999), weight_decay=0.1,
                 constructor='LayerDecayOptimizerConstructor', 
                 paramwise_cfg=dict(
                                    num_layers=12, 
                                    layer_decay_rate=0.77,
                                    custom_keys={
...
data = dict(
    ...
    train=[
        ...
        dict(
            ...
            ann_file=f'{aic_data_root}/ai_challenger_keypoint_train_20170909/aic_train.json',
