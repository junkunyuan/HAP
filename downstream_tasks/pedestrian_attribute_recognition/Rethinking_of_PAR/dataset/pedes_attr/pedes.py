...
class PedesAttr(data.Dataset):
    ...
    def __init__(self, cfg, split, transform=None, target_transform=None, idx=None):
        ...
        # self.root_path = dataset_info.root
        if cfg.DATASET.NAME == 'PETA':
            self.root_path = f'../../../../PETA/images'
        if cfg.DATASET.NAME == 'PA100k':
            self.root_path = f'../../../../PA-100K/data'
        if cfg.DATASET.NAME == 'RAP':
            self.root_path = f'../../../../RAP/RAP_dataset'
